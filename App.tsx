...
>
          ...
          <button 
            onClick={toggleAi}
            className={`p-4 rounded-full shadow-2xl transition-all hover:scale-110 flex items-center justify-center relative ${isAiOpen ? 'bg-red-500 text-white' : 'bg-indigo-600 text-white'}`}
